            ...
            <div class="dropdown-menu pull-left">
                ...
                <div class="dropdown-menu-member">
                    ...
                    <a href="<?php print base_url(); ?>membership/my_dashboard" class="block bg-white bg-darken pd-10">
                        <i class="fa fa-dashboard pd-l-10 pd-r-10" style="font-size: 18px; position:relative; top: 2px;"></i> Dashboard
                    </a>

                    <a href="<?php print base_url(); ?>membership/profile" class="block bg-white bg-darken pd-10">
                        <i class="fa fa-user pd-l-10 pd-r-10" style="font-size: 18px; position:relative; top: 2px;"></i> Profile
                    </a>

                    <a href="<?php print base_url(); ?>logout" class="block bg-success bg-darken fg-white pd-10">
                        <i class="fa fa-power-off pd-l-10 pd-r-10" style="font-size: 18px; position:relative; top: 2px;"></i> Log out
                    </a>
                </div>
            </div>
        </li>
