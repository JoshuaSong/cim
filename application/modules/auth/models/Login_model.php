...
class Login_model extends CI_Model {
    ...
    public function validate_login($identification = null, $password = null, $emailAllowed = false, $from_cookies = false, $cookie_part = null, $oauth = false, $oauth_email = null) {
        ...
        $a = array('u.user_id', 'u.username', 'u.password', 'u.active', 'u.banned', 'u.profile_img', 'u.login_attempts');
        ...
        if($q->num_rows() == 1) {
            ...
            return ($row->login_attempts + 1); // by not returning an array the login will fail
        }
