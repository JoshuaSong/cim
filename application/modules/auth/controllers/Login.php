...
class Login extends Auth_Controller {
    ...
    public function validate() {
        ...
        $this->form_validation->set_rules('password', $this->lang->line('login_password'), 'trim|required|min_length[9]|max_length[255]|is_valid_password');
