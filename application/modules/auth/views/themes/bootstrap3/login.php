...
<div class="row">
    ...
    <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
        ...
        <?php print form_open('auth/login/validate', 'id="login_form" class="js-parsley mg-b-15" data-parsley-submit="login_submit"') ."\r\n"; ?>
        ...
        <div class="form-group">
            <button type="submit" name="login_submit" id="login_submit" class="login_submit btn btn-primary btn-lg" data-loading-text="<?php print $this->lang->line('login_loading_text'); ?>">
