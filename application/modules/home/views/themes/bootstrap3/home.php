...
<img class="center-block" src="<?php print base_url(); ?>assets/img/public/logo.png" alt="logo">

<div class="text-center">
    <h3 class="fg-primary f900 text-uppercase">Version <?php print Settings_model::$db_config['cim_version']; ?></h3>
...
<div class="container text-center">
    ...
    <div class="row">
        <div class="col-sm-6">
            <a href="http://codeigniter.com"><img class="img-responsive center-block mg-b-15" src="<?php print base_url(); ?>assets/img/public/codeigniter-logo-sm.png" alt=""></a>
        </div>
        <div class="col-sm-6">
            <a href="http://getbootstrap.com"><img class="img-responsive center-block mg-b-15" src="<?php print base_url(); ?>assets/img/public/bootstrap3-sm.png" alt=""></a>
        </div>
    </div>
    ...
    <div class="row text-center">
        <div class="col-sm-6">
            <h3>Social logon</h3>
            <p>
                Make it easy on members to login and register by using Facebook, Google, Microsoft, Github or many of the other providers
                that offer OAuth2 authentication.
            </p>
        </div>
        <div class="col-sm-6">
    ...
    <h2>Many more features will be added based on your input.</h2>
    <p>72 tickets and counting for the next version(s) in an active development cycle.</p>
