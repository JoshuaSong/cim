...
<?php $this->load->view('themes/'. Settings_model::$db_config['adminpanel_theme'] .'/partials/content_head.php'); ?>
	...
	<div class="form-group clearfix">
		<label for="site_title">Version</label>
		
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4 clearfix">
				<input type="text" name="site_version" id="site_title" class="form-control"
                       value="<?php print Settings_model::$db_config['cim_version']; ?>"
                       data-parsley-trigger="change keyup"
                       data-parsley-maxlength="60"
                       required>
			</div>
