...
<div class="bg-white pd-15 mg-b-20">
    ...
    <?php print form_open('adminpanel/permissions/add_permission', array('id' => 'add_permission_form',  'class' => 'js-parsley form-inline', 'data-parsley-submit' => 'add_permission_save')) ."\r\n"; ?>
    ...
    <div>
        <button type="submit" class="add_permission_save btn btn-primary btn-lg" data-loading-text="<?php print $this->lang->line('permission_loading_text'); ?>"><i class="fa fa-plus pd-r-5"></i> <?php print $this->lang->line('permission_btn_create'); ?></button>
    </div>
...
<div class="bg-white pd-15 mg-b-20">
    ...
    <div>
        <button type="submit" name="edit" class="btn btn-primary" data-loading-text="Updating..."><i class="fa fa-refresh pd-r-5"></i> <?php print $this->lang->line('permission_edit'); ?></button>
        <button type="submit" name="delete" class="btn btn-danger js-confirm-delete" data-loading-text="<?php print $this->lang->line('permission_delete_loading_text'); ?>"><i class="fa fa-trash-o pd-r-5"></i> <?php print $this->lang->line('permission_delete'); ?></button>
