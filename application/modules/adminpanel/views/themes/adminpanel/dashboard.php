    ...
    <div class="col-sm-6 col-md-3">
        <div class="panel card bd-0">
            <div class="panel-body bg-primary">
                <h4><?php print $this->lang->line('dash_new_members_week'); ?></h4>
            </div>
            <div class="panel-body bg-white">
                <h3 class="mg-0 f900"><?php print number_format($new_week->count); ?></h3>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-md-3">
        <div class="panel card bd-0">
            <div class="panel-body bg-primary">
                <h4><?php print $this->lang->line('dash_new_members_month'); ?></h4>
            </div>
            <div class="panel-body bg-white">
                <h3 class="mg-0 f900"><?php print number_format($new_month->count); ?></h3>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-md-3">
        <div class="panel card bd-0">
            <div class="panel-body bg-primary">
                <h4><?php print $this->lang->line('dash_new_members_year'); ?></h4>
            </div>
            <div class="panel-body bg-white">
                <h3 class="mg-0 f900"><?php print number_format($new_year->count); ?></h3>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-md-3">
        <div class="panel card bd-0">
            ...
            <div class="panel-body bg-white">
                <h3 class="mg-0 f900"><?php print number_format($total_users); ?></h3>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-list-members">
                ...
                <tr>
                    ...
                    <th><?php print $this->lang->line('dashboard_last_login'); ?></th>
                </tr>
                </thead>
                <tbody>
                ...
                <?php foreach($latest_members as $member) { ?>
                    <tr>
                        ...
                        <td><?php print date('jS \o\f F Y', strtotime($member->last_login)); ?></td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
...
<h2>Static stuff (not translated)</h2>
