...
class Roles extends Admin_Controller {
    ...
    private function _edit($id, $data) {
        ...
        $this->session->set_flashdata('success', '<p>'. sprintf($this->lang->line('role_updated'), $data['role_name']) .'</p>');
        redirect('adminpanel/roles');
    }
    ...
    private function _delete($id) {
        ...
        $this->session->set_flashdata('success', '<p>'. sprintf($this->lang->line('role_removed'), $this->input->post('role_name')) .'</p>');
        redirect('adminpanel/roles');
    }
    ...
    public function save_role_permissions() {
       ...
       //     $this->session->set_flashdata('error', '<p>'. $this->lang->line('roles_admin_noedit_permissions') .'</p>');
      //      redirect('adminpanel/roles');
        }
